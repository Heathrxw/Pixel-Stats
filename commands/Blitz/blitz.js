    ...
    async execute(interaction) {;
        ...
        hypixelAPIReborn.getPlayer(username).then((player) => {
            ...
            const blitzsg = new MessageEmbed()
             ...
             .setThumbnail('https://hypixel.net/styles/hypixel-v2/images/game-icons/SG-64.png')
            ...
            con.query(`INSERT INTO Blitz (Mode,Username,Kills,Deaths,KDR,SoloWins,TeamWins,Coins) VALUES ('Blitz','${username}','${Kills}','${Deaths}','${KDR}','${SoloWins}','${TeamWins}','${Coins}')`)
        }).catch((err) => {
