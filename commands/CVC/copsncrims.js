  ...
  async execute(interaction) {
    ...
    hypixelAPIReborn
      ...
      .then((player) => {
        ...
        con.query(
          `INSERT INTO CVC (Mode,Username,Deaths,Wins,Coins,roundWins,shotsFired,headshotKills,bombsDefused,bombsPlanted,killsAsCrim,killsAsCop) VALUES ('CVC','${username}','${Deaths}','${Wins}','${Coins}','${RoundWins}','${ShotsFired}','${HeadshotKills}','${BombsDefused}','${BombsPlanted}','${killsAsCrim}','${killsAsCop}')`
        );
      })
      .catch((err) => {
