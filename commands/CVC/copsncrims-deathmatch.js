...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .setDescription(
      "Gets specified players stats for Cops n Crims Deathmatch statistics"
    )
  ...
  async execute(interaction) {
    ...
    hypixelAPIReborn
      ...
      .then((player) => {
        ...
        con.query(
          `INSERT INTO CVC (Mode,Username,Kills,Deaths,KDR,killsAsCrim,killsAsCop) VALUES ('CVCDeathmatch','${username}','${Kills}','${Deaths}','${KDR}','${KillsAsCrim}','${KillsAsCop}')`
        );
      })
      .catch((err) => {
