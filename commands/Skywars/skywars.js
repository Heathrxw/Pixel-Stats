  ...
  async execute(interaction) {
    ...
    hypixelAPIReborn
      ...
      .then((player) => {
        ...
        con.query(
          `INSERT INTO Skywars (Mode,Username,Kills,Deaths,Wins,Losses,KDR,WLR,Coins,Tokens,Level,Heads,Prestige,Souls) VALUES ('Overall','${username}','${Kills}','${Deaths}','${Wins}','${Losses}','${KDR}','${WLR}','${Coins}','${Tokens}','${Level}','${Heads}','${Prestige}','${Souls}')`
        );
      })
      .catch((err) => {
        interaction.reply(
