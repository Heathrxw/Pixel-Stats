...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .setDescription(
      "Gets specified players stats for ranked skywars statistics"
    )
  ...
  async execute(interaction) {
    ...
    hypixelAPIReborn
      ...
      .then((player) => {
        ...
        con.query(
          `INSERT INTO Skywars (Mode,Username,Kills,Deaths,Wins,Losses,KDR,WLR,playedGames) VALUES ('Ranked','${username}','${Kills}','${Deaths}','${Wins}','${Losses}','${KDR}','${WLR}','${playedGames}')`
        );
      })
      .catch((err) => {
