...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .setDescription(
      "Gets specified players stats for teams insane skywars statistics"
    )
  ...
  async execute(interaction) {
    ...
    hypixelAPIReborn
      .getPlayer(username)
      .then((player) => {
        const kills = player.stats.skywars.team.insane.kills;
        const deaths = player.stats.skywars.team.insane.deaths;
        const wins = player.stats.skywars.team.insane.wins;
        const losses = player.stats.skywars.team.insane.losses;
        ...
        con.query(
          `INSERT INTO Skywars (Mode,Username,Kills,Deaths,Wins,Losses,KDR,WLR) VALUES ('TeamsInsane','${username}','${kills}','${deaths}','${wins}','${losses}','${kdr}','${wlr}')`
        );
      })
      .catch((err) => {
