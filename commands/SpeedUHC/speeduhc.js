  ...
  async execute(interaction) {
    ...
    hypixelAPIReborn
      ...
      .then((player) => {
        ...
        con.query(
          `INSERT INTO SpeedUHC (Mode,Username,Kills,Deaths,Wins,Losses,KDR,WLR,playedGames,Winstreak,Coins) VALUES ('SpeedUHC','${username}','${Kills}','${Deaths}','${Wins}','${Losses}','${KDR}','${WLR}','${playedGames}','${Winstreak}','${Coins}')`
        );
      })
      .catch((err) => {
        interaction.reply(
