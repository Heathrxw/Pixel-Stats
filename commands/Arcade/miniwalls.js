  ...
  async execute(interaction) {
    ...
    hypixelAPIReborn
      ...
      .then((player) => {
        ...
        con.query(
          `INSERT INTO MiniWalls (Mode,Username,finalKills,witherKills,witherDamage,arrowHits,arrowShots,bowAccuracy) VALUES ('MiniWalls','${username}','${finalKills}','${witherKills}','${witherDamage}','${arrowHits}','${arrowShots}','${bowAccuracy}')`
        );
      })
      .catch((err) => {
        interaction.reply(
