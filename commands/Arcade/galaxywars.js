...
module.exports = {
    ...
    async execute(interaction) {;
        ...
        hypixelAPIReborn.getPlayer(username).then((player) => {
            ...
            con.query(`INSERT INTO GalaxyWars (Mode,Username,Kills,Deaths,Wins,ShotsFired,WeeklyKills,MonthlyKills,AttackerKills,DefenderKills) VALUES ('GalaxyWars','${username}','${Kills}','${Deaths}','${Wins}','${ShotFire}','${WeeklyKills}','${MonthKills}','${AttackKills}','${DefKills}')`)
        }).catch((err) => {
