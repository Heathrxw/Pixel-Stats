  ...
  async execute(interaction) {
    ...
    hypixelAPIReborn
      ...
      .then((player) => {
        ...
        const fastestRound10 =
          player.stats.arcade.zombies.overall.fastestRound10;
        const fastestRound20 =
          player.stats.arcade.zombies.overall.fastestRound20;
        const fastestRound30 =
          player.stats.arcade.zombies.overall.fastestRound30;
        const playersRevived =
          player.stats.arcade.zombies.overall.playersRevived;
        const timesKnockedDown =
          player.stats.arcade.zombies.overall.timesKnockedDown;
        const roundsSurvived =
          player.stats.arcade.zombies.overall.roundsSurvived;
        const windowsRepaired =
          player.stats.arcade.zombies.overall.windowsRepaired;
        ...
        const Zombies = new MessageEmbed()
          ...
          .addField(
            "Fastest Round 10 (Seconds)",
            commaNumber(fastestRound10),
            true
          )
          .addField(
            "Fastest Round 20 (Seconds)",
            commaNumber(fastestRound20),
            true
          )
          .addField(
            "Fastest Round 30 (Seconds)",
            commaNumber(fastestRound30),
            true
          )
