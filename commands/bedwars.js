...
module.exports = {
    ...
    async execute(interaction) {;
        ...
        hypixelAPIReborn.getPlayer(username).then((player) => {
            ...
            const deaths = (player.stats.bedwars.kills)
            ...
            const playedGames = (player.stats.bedwars.avg.playedGames)
            ...
            const BedsBroke = (player.stats.bedwars.beds.broke)
