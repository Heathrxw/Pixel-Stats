...
module.exports = {
    ...
    .addField('Invite Link', 'https://discord.com/api/oauth2/authorize?client_id=935249778994995321&permissions=414464674880&scope=bot%20applications.commands')
    .setFooter({ text: 'Stats Pixel Invite Link or https://pixel-stats.heathrxw.xyz'});
