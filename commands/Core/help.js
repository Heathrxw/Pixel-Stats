...
module.exports = {
    ...
    .addField('Commands', 'Most games are included if not, please go to the link in the footer!')
    .addField('Valid Modes', 'The valid games so far are: Skywars, Duels, Arcade, BedWars, Blitz, Build Battle, Classic, SpeedUHC, Warlords and Walls')
    ...
    .setThumbnail('https://i.heathrxw.xyz/hypixel.png')
    .addField('Arcade', '/zombies, /football, /mini-walls, /hole-in-the-wall, /galaxy-wars')
    .addField('Bedwars','/bedwars, /bedwars-solo, /bedwars-doubles, /bedwars-threes, /bedwars-fours')
    .addField('Blitz', '/blitz')
    .addField('Build Battle', '/build-battle')
    .addField('Classic', '/arena-brawl-solo, /arena-brawl-doubles, /arena-brawl-fours, /turbo-kart-racers, /turbo-kart-racers-maps, /vampirez, /walls')
    ...
    .addField('Changes', 'Added buttons to help menu, reformatted some commands, added new help menu, created new website, added database status, ')

    let page4 = new MessageEmbed()
    .setColor(color)
    .setTitle('Stats Pixel Status')
    .setThumbnail('https://i.heathrxw.xyz/hypixel.png')
    .addField('Status', 'You can view the public status of the bot here, including downtime, uptime and database issues')
