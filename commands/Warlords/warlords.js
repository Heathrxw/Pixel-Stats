...
module.exports = {
    ...
    async execute(interaction) {;
        ...
        hypixelAPIReborn.getPlayer(username).then((player) => {
            ...
            .setThumbnail('https://hypixel.net/styles/hypixel-v2/images/game-icons/Warlords-64.png')
            ...
            con.query(`INSERT INTO Warlords (Mode,Username,Kills,Deaths,Wins,Losses,KDR,WLR,Winstreak,Assists,Coins,Class) VALUES ('Warlords','${username}','${Kills}','${Deaths}','${Wins}','${Losses}','${KDR}','${WLR}','${Winstreak}','${Assists}','${Coins}','${Class}')`)
        }).catch((err) => {
