  ...
  async execute(interaction) {
    ...
    hypixelAPIReborn
      ...
      .then((player) => {
        ...
        con.query(
          `INSERT INTO BuildBattle (Mode,Username,Score,playedGames,coins,totalVotes,totalWins,SoloWins,TeamWins,ProWins,GTBWins) VALUES ('BuildBattle','${username}','${Score}','${playedGames}','${coins}','${totalVotes}','${totalWins}','${SoloWins}','${TeamWins}','${ProWins}','${GTBWins}')`
        );
      })
      .catch((err) => {
        interaction.reply(
