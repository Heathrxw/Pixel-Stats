...
module.exports = {
    ...
    async execute(interaction) {;
        ...
        hypixelAPIReborn.getPlayer(username).then((player) => {
            ...
            con.query(`INSERT INTO Duels (Mode,Username,Kills,Wins,Losses,WLR,playedGames,Division,MeleeSwings,MeleeHits) VALUES ('Boxing','${username}','${Kills}','${Wins}','${Losses}','${WLR}','${playedGames}','${Division}','${MeleeSwings}','${MeleeHits}')`)
        }).catch((err) => {
