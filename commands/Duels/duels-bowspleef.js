...
module.exports = {
    ...
    .setDescription('Gets specified players stats for Bow Spleef duels statistics')
    ...
    async execute(interaction) {;
        ...
        hypixelAPIReborn.getPlayer(username).then((player) => {
            ...
            con.query(`INSERT INTO Duels (Mode,Username,Deaths,Wins,Losses,WLR,playedGames,Winstreak,bestWinstreak,Division) VALUES ('BowSpleef','${username}','${Deaths}','${Wins}','${Losses}','${WLR}','${playedGames}','${Winstreak}','${bestWinstreak}','${Division}')`)
        }).catch((err) => {
