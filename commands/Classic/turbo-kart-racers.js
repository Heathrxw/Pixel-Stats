  ...
  async execute(interaction) {
    ...
    hypixelAPIReborn
      ...
      .then((player) => {
        ...
        con.query(
          `INSERT INTO TurboKartRacers (Mode,Username,Coins,Laps,BoxPickups,GoldTrophies,SilverTrophies,BronzeTrophies,Wins,Horn) VALUES ('TKR','${username}','${Coins}','${Laps}','${BoxPickups}','${goldTrophies}','${silverTrophies}','${bronzeTrophies}','${Wins}','${Horn}')`
        );
      })
      .catch((err) => {
        interaction.reply(
