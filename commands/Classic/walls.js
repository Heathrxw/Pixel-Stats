...
module.exports = {
    ...
    async execute(interaction) {;
        ...
        hypixelAPIReborn.getPlayer(username).then((player) => {
            ...
            con.query(`INSERT INTO Walls (Mode,Username,Kills,Deaths,Wins,Losses,KDR,WLR,Coins,Assists) VALUES ('Walls','${username}','${Kills}','${Deaths}','${Wins}','${Losses}','${KDR}','${WLR}','${Coins}','${Assists}')`)
        }).catch((err) => {
