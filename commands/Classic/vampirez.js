  ...
  async execute(interaction) {
    ...
    hypixelAPIReborn
      ...
      .then((player) => {
        ...
        con.query(
          `INSERT INTO Vampirez (Mode,Username,HKills,HDeaths,HKDR,HWins,ZKills,VKills,VDeaths,VKDR,Coins) VALUES ('VampireZ','${username}','${HKills}','${HDeaths}','${HKDR}','${HWins}','${ZKills}','${VKills}','${VDeaths}','${VKDR}','${Coins}')`
        );
      })
      .catch((err) => {
        interaction.reply(
